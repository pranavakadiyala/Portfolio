...
|------------------------------------------|---------------------------------------------------------------------------------|
| Adding more subjects and looking at more historical data | I will look at more data to add learning outcome effects for other subjects too. Will also split these graphs more explicitly so that they don't merge into each other like it happened with the math graphs. I will also add aditional section between learning outcome charts and X days lost so that its not so abrupt. Right now not sure what it could but maybe a leading 'slide' maybe. |
